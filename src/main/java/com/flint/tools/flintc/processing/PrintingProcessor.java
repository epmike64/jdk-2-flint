    ...
    public static class PrintingElementVisitor
        ...
        public PrintingElementVisitor visitModule(ModuleElement e, Boolean p) {
            ...
            if (!e.isUnnamed()) {
                ...
                indentation++;
                for (Directive directive : e.getDirectives()) {
        ...
        private void printDirective(Directive directive) {
            indent();
            (new PrintDirective(writer)).visit(directive);
            writer.println(";");
        }

        private static class PrintDirective implements DirectiveVisitor<Void, Void> {
