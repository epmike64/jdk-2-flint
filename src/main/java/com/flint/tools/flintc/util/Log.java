...
public class Log extends AbstractLog {
    ...
    public static final com.flint.tools.flintc.util.Context.Key<PrintWriter> errKey = new com.flint.tools.flintc.util.Context.Key<>();
    ...
    public static abstract class DiagnosticHandler {
         ...
         * Handle a diagnostic.
         */
        public abstract void report(com.flint.tools.flintc.util.JCDiagnostic diag);
    }
