...
import static com.flint.tools.flintc.util.JCDiagnostic.DiagnosticType.FRAGMENT;
 ...
 */
public abstract class AbstractDiagnosticFormatter implements DiagnosticFormatter<com.flint.tools.flintc.util.JCDiagnostic> {

    /**
     * JavacMessages object used by this formatter for i18n.
     */
    protected com.flint.tools.flintc.util.JavacMessages messages;
     ...
     */
    private JCList<Type> allCaptured = JCList.nil();
    ...
    public String formatKind(com.flint.tools.flintc.util.JCDiagnostic d, Locale l) {
        switch (d.getType()) {
    ...
    @Override
    public String format(com.flint.tools.flintc.util.JCDiagnostic d, Locale locale) {
        allCaptured = JCList.nil();
        return formatDiagnostic(d, locale);
    }

    protected abstract String formatDiagnostic(com.flint.tools.flintc.util.JCDiagnostic d, Locale locale);

    public String formatPosition(com.flint.tools.flintc.util.JCDiagnostic d, PositionKind pk, Locale l) {
        Assert.check(d.getPosition() != com.flint.tools.flintc.util.Position.NOPOS);
        return String.valueOf(getPosition(d, pk));
    }
    //where
    private long getPosition(com.flint.tools.flintc.util.JCDiagnostic d, PositionKind pk) {
        switch (pk) {
    ...
    public String formatSource(com.flint.tools.flintc.util.JCDiagnostic d, boolean fullname, Locale l) {
     ...
     */
    protected Collection<String> formatArguments(com.flint.tools.flintc.util.JCDiagnostic d, Locale l) {
        com.flint.tools.flintc.util.ListBuffer<String> buf = new ListBuffer<>();
     ...
     */
    protected String formatArgument(com.flint.tools.flintc.util.JCDiagnostic d, Object arg, Locale l) {
        if (arg instanceof com.flint.tools.flintc.util.JCDiagnostic) {
            String s = null;
            depth++;
            try {
                s = formatMessage((com.flint.tools.flintc.util.JCDiagnostic)arg, l);
            }
            finally {
                depth--;
            }
     ...
     */
    protected String formatIterable(com.flint.tools.flintc.util.JCDiagnostic d, Iterable<?> it, Locale l) {
     ...
     */
    protected JCList<String> formatSubdiagnostics(com.flint.tools.flintc.util.JCDiagnostic d, Locale l) {
        JCList<String> subdiagnostics = JCList.nil();
        ...
        if (maxDepth == -1 || depth < maxDepth) {
            ...
            try {
                ...
                int count = 0;
                for (com.flint.tools.flintc.util.JCDiagnostic d2 : d.getSubdiagnostics()) {
     ...
     */
    protected String formatSubdiagnostic(com.flint.tools.flintc.util.JCDiagnostic parent, com.flint.tools.flintc.util.JCDiagnostic sub, Locale l) {
     ...
     */
    protected String formatSourceLine(com.flint.tools.flintc.util.JCDiagnostic d, int nSpaces) {
        StringBuilder buf = new StringBuilder();
        DiagnosticSource source = d.getDiagnosticSource();
        int pos = d.getIntPosition();
        if (d.getIntPosition() == com.flint.tools.flintc.util.Position.NOPOS)
    ...
    protected String formatLintCategory(com.flint.tools.flintc.util.JCDiagnostic d, Locale l) {
