...
import static com.flint.tools.flintc.api.DiagnosticFormatter.PositionKind.*;
import static com.flint.tools.flintc.util.BasicDiagnosticFormatter.BasicConfiguration.*;
import static com.flint.tools.flintc.util.LayoutCharacters.DetailsInc;
import static com.flint.tools.flintc.util.LayoutCharacters.DiagInc;
...
public class BasicDiagnosticFormatter extends AbstractDiagnosticFormatter {
     ...
     */
    public BasicDiagnosticFormatter(com.flint.tools.flintc.util.Options options, com.flint.tools.flintc.util.JavacMessages msgs) {
    ...
    protected String addSourceLineIfNeeded(com.flint.tools.flintc.util.JCDiagnostic d, String msg) {
        if (!displaySource(d))
            return msg;
        else {
    ...
    protected String formatMeta(char c, com.flint.tools.flintc.util.JCDiagnostic d, Locale l) {
        switch (c) {
            case 'b':
            ...
            case 't': {
                ...
                case FRAGMENT:
                    ...
                    break;
                case ERROR:
                    usePrefix = (d.getIntPosition() == com.flint.tools.flintc.util.Position.NOPOS);
                    break;
                default:
                    usePrefix = true;
                }
    ...
    private String selectFormat(JCDiagnostic d) {
        com.flint.tools.flintc.util.DiagnosticSource source = d.getDiagnosticSource();
