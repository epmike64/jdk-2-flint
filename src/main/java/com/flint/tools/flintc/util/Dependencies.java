...
import com.flint.tools.flintc.util.GraphUtils.DotVisitor;
import com.flint.tools.flintc.util.GraphUtils.NodeVisitor;
...
public abstract class Dependencies {
    ...
    public static class GraphDependencies extends Dependencies implements Closeable, Completer {
        ...
        public static void preRegister(Context context) {
            context.put(dependenciesKey, (Context.Factory<Dependencies>) com.flint.tools.flintc.util.Dependencies.GraphDependencies::new);
        }
        ...
        public static abstract class Node extends GraphUtils.AbstractNode<ClassSymbol, Node>
             ...
             */
            EnumMap<com.flint.tools.flintc.util.Dependencies.CompletionCause, List<Node>> depsByKind;

            Node(ClassSymbol value) {
                super(value);
                this.depsByKind = new EnumMap<>(com.flint.tools.flintc.util.Dependencies.CompletionCause.class);
                for (com.flint.tools.flintc.util.Dependencies.CompletionCause depKind : com.flint.tools.flintc.util.Dependencies.CompletionCause.values()) {
            ...
            public GraphUtils.DependencyKind[] getSupportedDependencyKinds() {
                return com.flint.tools.flintc.util.Dependencies.CompletionCause.values();
            }
        ...
        @Override
        public void push(ClassSymbol s, com.flint.tools.flintc.util.Dependencies.CompletionCause phase) {
         ...
         */
        protected Node push(Node newNode, com.flint.tools.flintc.util.Dependencies.CompletionCause cc) {
        ...
        public void complete(Symbol sym) throws CompletionFailure {
            push((ClassSymbol)sym, com.flint.tools.flintc.util.Dependencies.CompletionCause.OTHER);
            pop();
            sym.completer = this;
        }
