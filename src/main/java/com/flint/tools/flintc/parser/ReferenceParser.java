...
public class ReferenceParser {
    ...
    static public class Reference {
        ...
        public final JCList<JCTree> paramTypes;

        Reference(JCTree qualExpr, Name member, JCList<JCTree> paramTypes) {
    ...
    private final com.flint.tools.flintc.parser.ParserFactory fac;
    ...
    private JCList<JCTree> parseParams(String s) throws ParseException {
        if (s.trim().isEmpty())
            return JCList.nil();
