...
import static com.flint.tools.flintc.code.TypeTag.INT;
import static com.flint.tools.flintc.jvm.ByteCodes.*;
import static com.flint.tools.flintc.jvm.UninitializedType.*;
import static com.flint.tools.flintc.jvm.ClassWriter.StackMapTableFrame;
...
/*---------- classfile fields: --------------- */
     ...
     */
    JCList<char[]> lineInfo = JCList.nil(); // handled in stack fashion
 ...
 ****************************************************************************/
     ...
     */
    public static int width(JCList<Type> types) {
        int w = 0;
 ...
 *************************************************************************/
    ...
    StackMapFrame getInitialFrame() {
        StackMapFrame frame = new StackMapFrame();
        JCList<Type> arg_types = ((MethodType)meth.externalType(types)).argtypes;
 ...
 ****************************************************************************/
    ...
    public void compressCatchTable() {
        ...
        JCList<Integer> handlerPcs = JCList.nil();
 ...
 ****************************************************************************/
    ...
    private int findExceptionIndex(TypeAnnotationPosition p) {
        ...
        JCList<char[]> iter = catchInfo.toList();
        for (int i = 0; i < len; ++i) {
