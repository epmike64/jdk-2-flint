...
public class TreeTranslator extends JCTree.Visitor {
     ...
     */
    public <T extends JCTree> JCList<T> translate(JCList<T> trees) {
     ...
     */
    public JCList<JCVariableDecl> translateVarDefs(JCList<JCVariableDecl> trees) {
        for (JCList<JCVariableDecl> l = trees; l.nonEmpty(); l = l.tail)
            l.head = translate(l.head);
        return trees;
    }
     ...
     */
    public JCList<JCTypeParameter> translateTypeParams(JCList<JCTypeParameter> trees) {
        for (JCList<JCTypeParameter> l = trees; l.nonEmpty(); l = l.tail)
            l.head = translate(l.head);
        return trees;
    }
     ...
     */
    public JCList<JCCase> translateCases(JCList<JCCase> trees) {
     ...
     */
    public JCList<JCCatch> translateCatchers(JCList<JCCatch> trees) {
    ...
    /**  Visitor method: translate a list of catch clauses in try statements.
     */
    public JCList<JCAnnotation> translateAnnotations(JCList<JCAnnotation> trees) {
 ...
 ****************************************************************************/
    ...
    public void visitNewArray(JCNewArray tree) {
        tree.annotations = translate(tree.annotations);
        JCList<JCList<JCAnnotation>> dimAnnos = JCList.nil();
        for (JCList<JCAnnotation> origDimAnnos : tree.dimAnnotations)
