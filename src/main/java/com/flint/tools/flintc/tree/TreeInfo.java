...
import static com.flint.tools.flintc.code.TypeTag.BOT;
import static com.flint.tools.flintc.tree.JCTree.JCTreeTag.*;
import static com.flint.tools.flintc.tree.JCTree.JCTreeTag.BLOCK;
import static com.flint.tools.flintc.tree.JCTree.JCTreeTag.SYNCHRONIZED;

import javax.tools.JavaFileObject;

import static com.flint.tools.flintc.tree.JCTree.JCOperatorExpression.OperandPos.LEFT;
import static com.flint.tools.flintc.tree.JCTree.JCOperatorExpression.OperandPos.RIGHT;
...
public class TreeInfo {
    ...
    public static JCList<JCExpression> args(JCTree t) {
        switch (t.getTag()) {
            case APPLY:
     ...
     */
    public static boolean hasConstructors(JCList<JCTree> trees) {
        for (JCList<JCTree> l = trees; l.nonEmpty(); l = l.tail)
    ...
    public static Env<AttrContext> scopeFor(JCList<JCTree> path) {
        // TODO: not implemented yet
        throw new UnsupportedOperationException("not implemented yet");
    }

    public static JCList<JCTree> pathFor(final JCTree node, final JCCompilationUnit unit) {
        class Result extends Error {
            static final long serialVersionUID = -5942088234594905625L;
            JCList<JCTree> path;
            Result(JCList<JCTree> path) {
                this.path = path;
            }
        }
        class PathFinder extends TreeScanner {
            JCList<JCTree> path = JCList.nil();
            public void scan(JCTree tree) {
                if (tree != null) {
     ...
     */
    public static JCList<Type> types(JCList<? extends JCTree> trees) {
     ...
     */
    public static int opPrec(JCTree.JCTreeTag op) {
        switch(op) {
        case POS:
        case NEG:
        case NOT:
    ...
    static Tree.Kind tagToKind(JCTree.JCTreeTag tag) {
        switch (tag) {
        // Postfix expressions
        case POSTINC:           // _ ++
