...
public class MemberEnter extends JCTree.Visitor {
    ...
    Type signature(MethodSymbol msym,
        ...
        JCList<Type> tvars = enter.classEnter(typarams, env);
        ...
        for (JCList<JCExpression> l = thrown; l.nonEmpty(); l = l.tail) {
 ...
 *********************************************************************/
     ...
     */
    void memberEnter(JCList<? extends JCTree> trees, Env<AttrContext> env) {
    ...
    static class InitTreeVisitor extends JCTree.Visitor {
        ...
        private static final Set<JCTreeTag> ALLOWED_OPERATORS =
                EnumSet.of(JCTreeTag.POS, JCTreeTag.NEG, JCTreeTag.NOT, JCTreeTag.COMPL, JCTreeTag.PLUS, JCTreeTag.MINUS,
                           JCTreeTag.MUL, JCTreeTag.DIV, JCTreeTag.MOD, JCTreeTag.SL, JCTreeTag.SR, JCTreeTag.USR,
                           JCTreeTag.LT, JCTreeTag.LE, JCTreeTag.GT, JCTreeTag.GE, JCTreeTag.EQ, JCTreeTag.NE,
                           JCTreeTag.BITAND, JCTreeTag.BITXOR, JCTreeTag.BITOR, JCTreeTag.AND, JCTreeTag.OR);
