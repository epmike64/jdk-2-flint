...
public class TypeAnnotationPosition {
    ...
    public static final JCList<TypePathEntry> emptyPath = JCList.nil();

    public final TargetType type;

    // For generic/array types.

    public JCList<TypePathEntry> location;
    ...
    // com.flint.tools.flintc.jvm.Gen.genCatch, we first use this to hold
    // the catch type's constant pool entry index.  Then in
    // com.flint.tools.flintc.jvm.Code.fillExceptionParameterPositions we
     ...
     */
    public static JCList<TypePathEntry> getTypePathFromBinary(java.util.List<Integer> list) {
    ...
    public static JCList<Integer> getBinaryFromTypePath(java.util.List<TypePathEntry> locs) {
    ...
    public static TypeAnnotationPosition
        methodReturn(final JCList<TypePathEntry> location,
                     final JCLambda onLambda,
                     final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        methodReceiver(final JCList<TypePathEntry> location,
                     final JCLambda onLambda,
                     final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        methodParameter(final JCList<TypePathEntry> location,
                        final JCLambda onLambda,
                        final int parameter_index,
                        final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        methodRef(final JCList<TypePathEntry> location,
                  final JCLambda onLambda,
                  final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        constructorRef(final JCList<TypePathEntry> location,
                       final JCLambda onLambda,
                       final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        field(final JCList<TypePathEntry> location,
              final JCLambda onLambda,
              final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        localVariable(final JCList<TypePathEntry> location,
                      final JCLambda onLambda,
                      final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        exceptionParameter(final JCList<TypePathEntry> location,
                           final JCLambda onLambda,
                           final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        resourceVariable(final JCList<TypePathEntry> location,
                         final JCLambda onLambda,
                         final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        newObj(final JCList<TypePathEntry> location,
               final JCLambda onLambda,
               final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        classExtends(final JCList<TypePathEntry> location,
                     final JCLambda onLambda,
                     final int type_index,
                     final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        instanceOf(final JCList<TypePathEntry> location,
                   final JCLambda onLambda,
                   final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        typeCast(final JCList<TypePathEntry> location,
                 final JCLambda onLambda,
                 final int type_index,
                 final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        methodInvocationTypeArg(final JCList<TypePathEntry> location,
                                final JCLambda onLambda,
                                final int type_index,
                                final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        constructorInvocationTypeArg(final JCList<TypePathEntry> location,
                                     final JCLambda onLambda,
                                     final int type_index,
                                     final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        typeParameter(final JCList<TypePathEntry> location,
                      final JCLambda onLambda,
                      final int parameter_index,
                      final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        methodTypeParameter(final JCList<TypePathEntry> location,
                            final JCLambda onLambda,
                            final int parameter_index,
                            final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        methodThrows(final JCList<TypePathEntry> location,
                     final JCLambda onLambda,
                     final int type_index,
                     final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        methodRefTypeArg(final JCList<TypePathEntry> location,
                         final JCLambda onLambda,
                         final int type_index,
                         final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        constructorRefTypeArg(final JCList<TypePathEntry> location,
                              final JCLambda onLambda,
                              final int type_index,
                              final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        typeParameterBound(final JCList<TypePathEntry> location,
                           final JCLambda onLambda,
                           final int parameter_index,
                           final int bound_index,
                           final int pos) {
     ...
     */
    public static TypeAnnotationPosition
        methodTypeParameterBound(final JCList<TypePathEntry> location,
                                 final JCLambda onLambda,
                                 final int parameter_index,
                                 final int bound_index,
                                 final int pos) {
