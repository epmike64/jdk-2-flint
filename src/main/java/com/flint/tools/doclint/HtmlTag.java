...
import static com.flint.tools.doclint.HtmlTag.Attr.*;
 ...
 *
 * This is derivative of com.flint.tools.doclets.formats.html.markup.HtmlTag.
        ...
        public boolean accepts(HtmlTag t) {
            switch (t) {
                case HEADER: case FOOTER: case MAIN:
                    return false;
                default:
                    return (t.blockType == HtmlTag.BlockType.BLOCK) || (t.blockType == HtmlTag.BlockType.INLINE);
            }
        }
    },
        ...
        public boolean accepts(HtmlTag t) {
            switch (t) {
                case IMG: case BIG: case SMALL: case SUB: case SUP:
                    return false;
                default:
                    return (t.blockType == HtmlTag.BlockType.INLINE);
            }
        }
    },
